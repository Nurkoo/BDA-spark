...
[Route("api/v1/claim-hub/exposure")]
public class ClaimHubExposureController : ControllerBase
{
    private readonly BdaPostgresContext context;
    private readonly PagedCriteria.Validator validator;

    public ClaimHubExposureController(BdaPostgresContext context, PagedCriteria.Validator validator)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Results.Json(await this.context.ClaimHubExposures.FindPaged(pagedCriteria, cancellationToken));
    }
}
